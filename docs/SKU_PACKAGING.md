...
Plan 02 (**Complete**): optional **can** and **bottle** packaging specs on `SKU`, low-poly mesh, dedicated packaging editor with live 2D/3D preview, and read-only planogram 3D scaffold.
